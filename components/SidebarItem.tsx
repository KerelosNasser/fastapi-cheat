    ...
    <div>
      ...
      {!isCollapsed && (
        <div
          ...
          style={{ maxHeight: isExpanded ? `${section.topics.length * 36}px` : "0px", opacity: isExpanded ? 1 : 0 }}
        >
...
function TopicLink({
  ...
  return (
    <Link
      ...
      onClick={onNavigate}
      className={`
        relative flex items-center pl-9 pr-3 h-9 text-[13px] transition-colors duration-100
        ${
          isActive
