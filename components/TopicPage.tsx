  ...
  return (
    <article className="max-w-3xl mx-auto px-8 py-10">
      ...
      <header className="mb-8">
        {/* Breadcrumb */}
        <nav aria-label="Breadcrumb" className="flex items-center gap-1 text-[12px] text-[var(--muted)] mb-3">
        ...
        <div className="flex items-center gap-3 flex-wrap">
          <h1 className="text-[28px] font-semibold text-[var(--foreground)] text-balance leading-tight">
            {topic.title}
          </h1>
          {methodStyle && topic.httpMethod && (
            <span
              className="text-[11px] font-mono font-bold px-2.5 py-1 rounded uppercase tracking-wider"
              style={{
      ...
      <section className="mb-8 flex flex-col gap-3">
        {/* Description card */}
        <div
          className="px-4 py-3.5 rounded-lg text-[13.5px] text-[var(--foreground)] leading-relaxed"
          style={{
            borderLeft: "2px solid var(--fastapi-teal)",
        ...
        {topic.warnings.map((warning, i) => (
          <div
            key={i}
            className="flex items-start gap-3 px-4 py-3 rounded-lg text-[13px] leading-relaxed"
            style={{
